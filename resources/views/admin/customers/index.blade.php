...
<div x-data="customerManager()">
    ...
    <div class="flex justify-between items-center mb-6">
        <div class="relative w-full md:w-72">
            <input type="text" x-model="search" placeholder="Search name, email, phone..." 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <table class="w-full text-left border-collapse whitespace-nowrap">
            ...
            <tbody class="divide-y divide-gray-100 text-sm text-gray-700">
                ...
                <tr x-show="matchesSearch('{{ strtolower($customer->name . $customer->email . $customer->phone) }}')" class="hover:bg-gray-50 transition" id="row-{{ $customer->id }}">
                    <td class="px-6 py-4">
